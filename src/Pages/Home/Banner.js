        ...
        <div className='w-full lg:w-11/12 px-4 py-8 lg:px-6 mx-auto'>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-5'>
                <div data-aos="fade-right" data-aos-duration="1000" className='self-center'>
                    ...
                    <div className='flex'>
                        <button type='submit' className='banner-btn font-semibold outline-0 border-0 mt-16 bg-primary text-secondary rounded-lg px-4 py-2 md:px-6 md:py-4 text-xl '>Get Started</button><img src={vector} alt="vector" />
                    </div>
                </div>
                <div>
