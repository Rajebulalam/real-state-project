        ...
        <div className='w-full lg:w-11/12 px-4 py-12 lg:px-6 mx-auto'>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-5'>
                <div className='self-center'>
                    ...
                    <div className='flex'>
                        <button type='submit' className='btn outline-0 border-0 mt-16 bg-secondary text-primary hover:bg-primary hover:text-secondary rounded-lg'>Get Started</button><img src={vector} alt="vector" />
