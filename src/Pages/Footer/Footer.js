                ...
                <div className='w-full lg:w-11/12 px-4 lg:px-6 mx-auto'>
                    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
                        ...
                        <div className='text-center md:text-start'>
                            ...
                            <p className='text-white text-xl pb-2'> <FontAwesomeIcon className='text-xl text-secondary pr-3' icon={faEnvelope}></FontAwesomeIcon> habibur@assetsignrealestate.com </p>
                        </div>
                    </div>
                </div>
            </div>
